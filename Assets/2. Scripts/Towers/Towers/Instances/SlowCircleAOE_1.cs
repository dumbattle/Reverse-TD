...
namespace Core {
    public class SlowCircleAOE_1 : CircleAOE_1 {
        ...
        static float[] _slowPower = {
            .7f, .8f, .9f, 1.0f, 1.1f, 1.2f,
            1.3f, 1.4f, 1.5f
        };
        static float[] _slowTime = {
            3, 3.5f, 4, 4.5f, 5, 5.5f,
            6, 6.5f, 7
        };

        TowerUpgradeDetails slowUpgrade = new TowerUpgradeDetails(TowerUpgradeIdUtility.DAMAGE, 30, 60, 120, 210, 330, 480, 660);
