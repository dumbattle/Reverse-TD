...
namespace Core {
    public class CreepAttachment_Resource_Red : CreepAttachmentDefinition {
        static CreepAttachment_Resource_Red instance = new CreepAttachment_Resource_Red();
        public static CreepAttachment_Resource_Red Get() => instance;

        CreepAttachment_Resource_Red() { }
        ...
        public override string GetName(int level) {
            return "Red Collecter";
        }

        public override Sprite GetIcon(int level) {
            return IconResourceCache.resourceRed;
        }
