...
namespace Core {
    public class CreepAttachment_Specialization_Spd2Count : CreepAttachmentDefinition {
        ...
        public override void ApplyModification(int level, CreepStatSet stats) {
            stats.count.AddModification(_statScales[level - 1] / 100f, 0);
            stats.spawnRate.AddModification(_statScales[level - 1] / 100f, 0);
            stats.spd.AddModification(1 - (100 / (100f - SPD_DECREASE)), 0);
        }
